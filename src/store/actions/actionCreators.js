...
// export { addEmployee, removeEmployee, fetchEmployees } from "./employees";
...
// export {getLastUpdate} from "./history";

export {fetchDatabase, addEmployee, removeEmployee } from "./API";